  ...
  border-radius: 4px;
    ...
    <body>
        ...
        <form action="menus.php" method="post">
            ...
            <h3> dia :</h3><input type="text" name="dia">
            <BR><BR>
            ...
            <br><br><a href='menus_excel.php'>exportar</a>
            ...
            if (isset($_POST['EJECUTAR']) && isset($_POST['opciones']))
            {
                ...
                if ($_POST['opciones']=='INSERTAR')
                {
                    ...
                    $sql="INSERT INTO menus ( COD_SEDE, DIA) VALUES('$codse','$dia')";
                ...
                else if ($_POST['opciones']=='VISUALIZAR')
                {
                    ...
                    {
						echo"<br> ".$pr['ID']." | ".$pr['COD_SEDE']." | ".$pr['DIA'];
                    }
                }
                ...
                {
                    $conn = oci_connect("prueba","prueba","localhost/XE");
                    $sql="UPDATE menus SET COD_SEDE='$codse',DIA='$dia' WHERE ID='$id'";
                    $union = oci_parse($conn,$sql);
                    oci_execute($union);
                    echo "DATOS EDITADOS";
                }
