  ...
  border-radius: 4px;
    ...
    <body>
        ...
        <form action="managers.php" method="post">
            ...
            <h3> universidad :</h3><input type="text" name="universidad">
            ...
            <br><br><a href='managers_excel.php'>exportar</a>
            ...
            if (isset($_POST['EJECUTAR']) && isset($_POST['opciones']))
            {
                ...
                if ($_POST['opciones']=='INSERTAR')
                {
                    ...
                    $sql="INSERT INTO managers VALUES('$Dni','$codse','$nombre','$tel','$universidad','$asistencias',TO_DATE('$fcha', 'DD/MM/YYYY'))";
                ...
                {
                    $conn = oci_connect("prueba","prueba","localhost/XE");
                    $sql="DELETE FROM managers WHERE DNI='$id'";
                    $union=oci_parse($conn,$sql);
                    oci_execute($union);
                ...
                else if ($_POST['opciones']=='VISUALIZAR')
                {
                    ...
                    {
						echo"<br> ".$pr['DNI']." | ".$pr['COD_SEDE']." | ".$pr['NOMBRE']." | ".$pr['TELEFONO']." | ".$pr['UNIVERSIDAD']." | ".$pr['ASISTENCIAS']." | ".$pr['FCHA_INICIO'];
                    }
                }
                ...
                {
                    $conn = oci_connect("prueba","prueba","localhost/XE");
                    $sql="UPDATE managers SET COD_DNI='$Dni',COD_SEDE='$codse',NOMBRE='$nombre',TELEFONO='$tel',UNIVERSIDAD='$universidad',ASISTENCIAS='$asistencias',FCHA_INICIO='$fcha' WHERE DNI='$id'";
                    $union = oci_parse($conn,$sql);
                    oci_execute($union);
                    echo "DATOS EDITADOS";
                }
